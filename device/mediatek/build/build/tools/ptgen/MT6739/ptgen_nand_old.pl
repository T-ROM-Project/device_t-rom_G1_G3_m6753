...
my $EMMC_COMPO	= "$CD_ALPS/device/mediatek/build/build/tools/ptgen/MT6570/mbr_addr.pl" ;
...
if($ENV{PTGEN_CHECKOUT} eq "yes")
{
  ...
  $COPY_PATH_KERNEL_PARTITION_H="kernel-3.4/arch/arm/mach-mt6570/$PROJECT/common";
  $COPY_PATH_PARTITION_DEFINE_H_NAME_K="kernel-3.4/arch/arm/mach-mt6570/$PROJECT/common";
  $COPY_PATH_PARTITION_DEFINE_C_NAME  ="kernel-3.4/arch/arm/mach-mt6570/$PROJECT/common";  
  $COPY_PATH_PMT_H_NAME_K="kernel-3.4/arch/arm/mach-mt6570/$PROJECT/common";  
  $COPY_PATH_COMBO_NAND_KERNELH="kernel-3.4/arch/arm/mach-mt6570/$PROJECT/common"; 
...
else
{
  ...
  $COPY_PATH_KERNEL_PARTITION_H="$CD_ALPS/kernel-3.4/arch/arm/mach-mt6570/$PROJECT/common";
  $COPY_PATH_PARTITION_DEFINE_H_NAME_K="$CD_ALPS/kernel-3.4/arch/arm/mach-mt6570/$PROJECT/common";
  $COPY_PATH_PARTITION_DEFINE_C_NAME  ="$CD_ALPS/kernel-3.4/arch/arm/mach-mt6570/$PROJECT/common";  
  $COPY_PATH_PMT_H_NAME_K="$CD_ALPS/kernel-3.4/arch/arm/mach-mt6570/$PROJECT/common";  
  $COPY_PATH_COMBO_NAND_KERNELH="$CD_ALPS/kernel-3.4/arch/arm/mach-mt6570/$PROJECT/common"; 
...
sub load_partition_info {
  ...
  else
  {
	  ...
	  my $SearchFile = 'partition_table_nand_MT6570.xls'; #Search File Name  
	  ...
	  {
	    #search folder list+{project}/partition_table_nand_MT6570.xls existence
...
print "PTGEN_ENV=$PTGEN_ENV\n";
  if(($PTGEN_ENV eq "ALL") || ($PTGEN_ENV eq "ANDROID") || ($PTGEN_ENV eq "PROJECT"))
  {
		...
		printf "check $SCAT_NAME_DIR/MT6570_Android_scatter.txt $COPY_SCATTER_BR_FILES_PATH\n";
		if (-e "$SCAT_NAME_DIR/MT6570_Android_scatter.txt") {
			printf "Copy $SCAT_NAME_DIR/MT6570_Android_scatter.txt $COPY_SCATTER_BR_FILES_PATH\n";
			copy_file("$SCAT_NAME_DIR/MT6570_Android_scatter.txt",$COPY_SCATTER_BR_FILES_PATH);
		}
